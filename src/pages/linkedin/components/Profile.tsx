...
const Profile = () => {
    ...
    return (
        <div className="flex flex-col gap-2">
            ...
            <div
                className='flex items-center justify-center md:hidden cursor-pointer w-full hover:bg-[#0000000d] transition-all duration-300 p-1 text-black'
                onClick={() => setShowMore(!showMore)}
            >
                <span className='text-xs leading-base font-[600]'>
